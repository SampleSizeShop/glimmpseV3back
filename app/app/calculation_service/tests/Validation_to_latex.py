...
def tex_table_test_4(file_path, output_name, V3_JSON: [], V2_results):
    ...
    _df_v2results = _df_v2results.sort_values(['Beta Scale'], ignore_index=True)
...
# test8 = tex_table(file_path, ['Example_8_Power_for_tests_of_polynomial_trend_for_multiple_between_and_within_subject_factors_using_3way_orthogonal_polynomial_contrasts.json'], 'Example_8_Power_for_tests_of_polynomial_trend_for_multiple_between_and_within_subject_factors_using_3way_orthogonal_polynomial_contrasts.csv')
# test9 = tex_table_test_9(file_path, 'Example_9_MEST_Power_for_a_multivariate_model_with_two_within_subject_factors_using_the_Muller_Edwards_Simpson_Taylor_approximation',['Example_9_MEST_Power_for_a_multivariate_model_with_two_within_subject_factors_using_the_Muller_Edwards_Simpson_Taylor_approximation.json'], 'Example_9_MEST_Power_for_a_multivariate_model_with_two_within_subject_factors_using_the_Muller_Edwards_Simpson_Taylor_approximation.csv')
